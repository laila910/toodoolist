...
<body>
    ...
    <div class="container">
        ...
        <div class="page-header">
            <h1>Read Users || <a href="{{ url('/task/create') }}">add</a> || <a
                    href="{{ url('/Logout') }}">LogOut</a> </h1>
        ...
        <table class='table table-hover table-responsive table-bordered'>
            ...
            @foreach ($data as $fetchedData)
                ...
                <tr>
                    ...
                    <th>{{ $fetchedData->title }}</th>
                    <th>{{ $fetchedData->desc }}</th>

                    <th> <a href='' data-toggle="modal" data-target="#modal_single_del_{{ $fetchedData->id }}"
                            class='btn btn-danger m-r-1em'>Delete</a>
                        <a href='{{ url('/task/' . $fetchedData->id . '/edit') }}'
                            class='btn btn-primary m-r-1em'>Edit</a></td>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <form action="{{ url('task/' . $fetchedData->id) }}" method="post">
                                    {{ csrf_field() }}
